<div class="container mt-4">
    ...
    <div class="mb-3">
        <a href="<?= site_url('lokasi_absen/lokasi_absensi') ?>" class="btn btn-success">Tambah Lokasi Absen</a>
    </div>
            ...
            <?php if (!empty($lokasi_list)): ?>
                <?php foreach ($lokasi_list as $index => $lokasi): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= site_url('lokasi_absen/edit/' . $lokasi->id) ?>" 
                               class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?= site_url('lokasi_absen/hapus/' . $lokasi->id) ?>" 
