            ...
            <?php if (!empty($potongan)): ?>
                <?php foreach ($potongan as $row): ?>
                    <tr>
                        ...
                        <td class="nowrap text-right">Rp <?= number_format($row->nilai, 2, ',', '.') ?></td>
                        <td class="nowrap text-center"><?= $row->keterangan ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="3" class="text-center">Tidak ada data potongan.</td>
                </tr>
            <?php endif; ?>
        </tbody>
<tfoot>
    <tr class="font-weight-bold">
        ...
        <td class="nowrap text-right">Rp <?= number_format($total_potongan, 2, ',', '.') ?></td>
    </tr>
</tfoot>
